...
public class I2CExample1 {
    ...
    // TSL2561 I2C address
    public static final int I2C_ADDR = 0x3c; // address pin not connected (FLOATING)
...
//                console.println("Unsupported I2C bus " + number + " required");
        ...
        I2CDevice device = i2c.getDevice(I2C_ADDR);
