...
public class Ssd1306v2 /*implements Closeable*/ {
    ...
    static {
        FONTS_ARRAY = new FontItem[]{
                ...
                AerxTabsMemesbruh0316px.FONT,  //very good
...
//    }
     ...
     * @throws IOException
     */
    public Ssd1306v2(I2CBus i2cBus) throws IOException {
     ...
     * @throws IOException
     */
    public Ssd1306v2(I2CBus i2cBus, int width, int height) throws IOException {
     ...
     * @throws IOException
     */
    public Ssd1306v2(I2CBus i2cBus, int i2cAddress) throws IOException {
     ...
     * @throws IOException
     */
    public Ssd1306v2(I2CBus i2cBus, int i2cAddress, int width, int height) throws IOException {
        try {
...
//            }
     ...
     * @throws IOException
     */
    Ssd1306v2(I2CDevice device) throws IOException {
...
//                logMsg("Char " + strChar + " IGNORED -> blank shown");
    ...
    public final void showFontDemoScreen(String demoFont, String message) throws IOException {
        clearPixels();
        selectFont(Monobit16px.FONT.getName());
...
//                logMsg("row[" + rowIndex + ", " + startIndex + "] " + rowSize + " chars Height " + charDataHeight + "px");
     ...
     */
    public static Ssd1306v2 createI2CDisplay(final int busId) {
        Ssd1306v2 ssd1306Display;
        try {
            final I2CBus i2CBus = I2CFactory.getInstance(busId);
            System.out.println("Found I2C BUS 1");
            ssd1306Display = new Ssd1306v2(i2CBus);
